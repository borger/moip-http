...
namespace Prothos\Moip\Auth;

use JsonSerializable;
use Prothos\Moip\Contracts\Authentication;
use Prothos\Moip\Exceptions\InvalidArgumentException;
use Prothos\Moip\Exceptions\UnexpectedException;
use Prothos\Moip\Exceptions\ValidationException;
